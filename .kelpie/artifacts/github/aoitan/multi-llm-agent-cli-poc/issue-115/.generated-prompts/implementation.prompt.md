...
- `.kelpie/artifacts/github/aoitan/multi-llm-agent-cli-poc/issue-115/04-plan.md` に沿って実装する
- 計画との差分がある場合は必ず理由を書く
- 無関係な改善を混ぜない
- 変更内容を `.kelpie/artifacts/github/aoitan/multi-llm-agent-cli-poc/issue-115/05-implementation-notes.md` に残す
